    ...
    "paths": {
        ...
        "/me/liked-songs/{songId}/status": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "成功返回喜欢状态",
                        "schema": {
                            "$ref": "#/definitions/models.LikeStatusResponse"
                        }
                    },
                    "401": {
                        "description": "{\"error\": \"需要认证（未提供Token或Token无效）\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/me/{userId}/follow": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.FollowStatusResponse"
                        }
                    },
                    "400": {
                    ...
                    "500": {
                        "description": "{\"error\": \"获取关注状态失败，请稍后重试\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "{\"error\": \"关注或取关失败操作失败，请稍后重试\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
